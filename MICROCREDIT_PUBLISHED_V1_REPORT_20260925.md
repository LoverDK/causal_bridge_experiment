# Published-summary microcredit pilot: sources, results, and limits

This report documents two explicitly versioned descriptive analyses run on
2026-09-25. The published-cell source correction and population sensitivity
were selected after earlier results were visible; neither is preregistered.
These analyses do not establish real mechanism calibration, measurement
equivalence, or a common causal effect.
The randomized assignments concern geographic service access or promotion,
not invitations randomized separately to individuals.
...
working tree based on HEAD `0b33a55d2bb2796397d256234a985af8fdf5af71`;
the commit alone does not identify these versioned input and runner bytes.
...
and old result directory were not overwritten and are outside this package.
...
The scope is an auditable, source-corrected descriptive
